...
//                .subscribe(o -> {
//                    if (mMusicConfig) {
//                        MusicActivitybac.this.readyMusic();
//                    } else {
//                        ToastUtil.showNoMusic(MusicActivitybac.this);
//                    }
//                });
    }
...
//        }
    ...
    private void initRxBusData() {
        ...
        disposables.add(mBus.toObserverable(MusicBean.class)
                ...
                .subscribe(musicItem -> {
                    // 将MusicConfig设置为ture
                    SharePrefrencesUtil.setMusicConfig(MusicActivitybac.this);
                    mMusicConfig = true;
                    MusicActivitybac.this.perpareItem(musicItem);
                    //更新播放状态按钮
                    MusicActivitybac.this.updatePlayBtnStatus();
                    //初始化动画
                    MusicActivitybac.this.initAnimation();
                    //更新歌曲的进度
                    MusicActivitybac.this.updataProgress();
        ...
        disposables.add(mBus.toObserverable(MusicStatusBean.class)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(MusicActivitybac.this::refreshBtnAndNotify));
    ...
    private void refreshBtnAndNotify(MusicStatusBean bean) {
        ...
        switch (bean.getType()) {
            case 0:
                ...
                break;
            case 1:
                startActivity(new Intent(this, MusicActivitybac.class));
                break;
            case 2:
                finish();
                break;
