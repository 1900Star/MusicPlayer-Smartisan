...
public class FlowLayoutView extends ViewGroup {
        ...
        for (int i = 0; i < searchList.size(); i++) {
            ...
            childView.setOnClickListener(v -> {
                if (mItemClickListener != null) {
                    mItemClickListener.itemClick(finalPosition, historyBean);
                }
            });
            addView(childView);
        }
    ...
    public void clearView(List<SearchHistoryBean> beanList) {
        removeAllViews();
    ...
    public interface OnItemClickListener {
        void itemClick(int position, SearchHistoryBean bean);
    }
